...
import Cobro from '../components/Movimientos/Cobro.vue';
import Transferencia from '../components/Movimientos/Transferencia.vue';
...
<template>
    ...
    <contextHeader title="Movimientos"></contextHeader>
        <div>
